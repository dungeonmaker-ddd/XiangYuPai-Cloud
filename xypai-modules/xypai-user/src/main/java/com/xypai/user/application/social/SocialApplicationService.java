package com.xypai.user.application.social;

import com.xypai.user.application.social.command.FollowUserCommand;
import com.xypai.user.application.social.command.UnfollowUserCommand;
import com.xypai.user.application.social.command.UpdateSocialSettingsCommand;
import com.xypai.user.domain.shared.service.DomainEventPublisher;
import com.xypai.user.domain.social.SocialAggregate;
import com.xypai.user.domain.social.repository.SocialRepository;
import com.xypai.user.domain.user.repository.UserRepository;
import com.xypai.user.domain.user.valueobject.UserId;
import com.xypai.user.infrastructure.cache.social.SocialGraphCacheService;
import com.xypai.user.insurance.dto.social.SocialStatsResponse;
